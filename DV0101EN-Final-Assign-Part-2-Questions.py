...
# Define the callback function to update the input container based on selected statistics
@app.callback(
...
def update_output_container(selected_statistics, input_year):
    ...
    if selected_statistics == "Recession Period Statistics":
        ...
        unemp_col = "unemployment_rate" if "unemployment_rate" in recession_data.columns else "Unemployment_Rate"
        unemp_data = recession_data.groupby([unemp_col, "Vehicle_Type"])["Automobile_Sales"].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(
                unemp_data,
                x=unemp_col,
        ...
        # Plot 3 Average number of vehicles sold by vehicle type during selected year
